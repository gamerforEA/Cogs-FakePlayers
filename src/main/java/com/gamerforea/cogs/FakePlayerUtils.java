...
public final class FakePlayerUtils
{
	...
	{
		return new WeakReference<FakePlayer>(createFakePlayer(new GameProfile(UUID.fromString("95762508-ece9-11e4-90ec-1681e6b88ec1"), "[RailCraft]"), world));
	}
